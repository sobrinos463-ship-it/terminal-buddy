...
serve(async (req) => {
  ...
  try {
    ...
    console.log("Authenticated user for stt-coach:", user.id);
    ...
    formData.append("language_code", "spa"); // Spanish by default
    ...
    console.error("stt-coach error:", error);
    return new Response(
      JSON.stringify({ error: error instanceof Error ? error.message : "STT error" }),
